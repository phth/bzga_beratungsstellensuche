...
class MigratePluginsUpdate implements UpgradeWizardInterface
{
    private const MIGRATION_SETTINGS = [
        ...
        [
            ...
            'targetListType' => 'bzgaberatungsstellensuche_list',
        ],
        [
            'switchableControllerActions' => 'Entry->form;Entry->autocomplete',
            'targetListType' => 'bzgaberatungsstellensuche_show',
        ],
    ];
    ...
    {
        return '[Beratungsstellensuche] Migrate plugins';
    }
